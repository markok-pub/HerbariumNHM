...
pretrained_filename = "./saved_models/contrastive_models/MB_NEW_SimCLR_Eval_4_Validated.ckpt"
...
def train_logreg(batch_size, train_feats_data, test_feats_data, model_suffix, max_epochs=900, **kwargs):
...
wandb.init(
    ...
    config={
    "learning_rate": 1e-3,
    "architecture": "MB_NEW_SimCLR_Eval_4_Validated",
    "dataset": "Subset-200",
    "epochs": 900,
    }
)
